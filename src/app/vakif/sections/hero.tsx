        ...
        <div className="md:col-span-5 flex justify-center w-full">
          <ScrollReveal direction="right" distance={50} delay={0.2} className="w-full flex justify-center">
            <div className="relative w-full max-w-[500px] md:max-w-[460px] lg:max-w-[520px] aspect-[966/1080]">
              {/* Subtle visual drop shadow matching premium aesthetic */}
              <div className="absolute inset-0 bg-neutral-900/5 blur-3xl rounded-3xl transform translate-y-6 scale-95 pointer-events-none" />
              <Image
                src="/images/vakif/ana-sayfa-2.png"
                alt="Birleşiyoruz — Nos Canda One"
                fill
                className="object-contain drop-shadow-[0_15px_30px_rgba(28,25,23,0.06)]"
                priority
