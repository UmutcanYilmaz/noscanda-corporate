        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 w-full flex justify-center">
            <ScrollReveal direction="right" distance={40} className="w-full max-w-[500px]">
              ...
              <div 
                className="relative w-full aspect-[4/5] rounded-[39px] overflow-hidden p-6 flex items-center justify-center border border-[#BA5225]/15 shadow-[0_20px_50px_rgba(186,82,37,0.08)] transition-transform duration-500 hover:scale-105"
                style={{
                  background: 'linear-gradient(135deg, #F3F0DB 0%, #FFFFFF 100%)',
                }}
              >
