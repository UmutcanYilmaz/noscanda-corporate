        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 order-last lg:order-first w-full flex justify-center">
            <ScrollReveal direction="left" distance={40} className="w-full max-w-[500px]">
              ...
              <div className="relative w-full aspect-[3/4] select-none pointer-events-none transition-transform duration-700 hover:scale-105">
                <picture className="w-full h-full">
                  <source media="(max-width: 1023px)" srcSet="/images/akademi/sundugumuzimkanlar-yatay.png" />
                  <img
