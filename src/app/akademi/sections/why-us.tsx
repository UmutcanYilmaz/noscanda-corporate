          ...
          {WHY_CARDS.map((card, idx) => (
            ...
            >
              <div className="flex flex-col w-full text-center group">
                {/* Transparent Image Wrapper (Enlarged to 280px) */}
                <div className="relative aspect-square w-full max-w-[280px] mx-auto mb-6 select-none pointer-events-none transition-transform duration-500 hover:scale-105">
                  <Image
                    src={card.image}
                    alt={card.title}
                    fill
