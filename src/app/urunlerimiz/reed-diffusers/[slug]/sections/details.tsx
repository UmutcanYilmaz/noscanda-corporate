...
/**
 * Reed Diffusers detail Details Section
 */
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {product.secondaryImage && (
              <ScrollReveal direction="left" delay={0.1}>
                <div className="relative aspect-[4/3] rounded-xl bg-[var(--bg-secondary)] border border-[var(--border-subtle)] overflow-hidden flex items-center justify-center p-6 shadow-glass magnetic-hover">
                  <Image
