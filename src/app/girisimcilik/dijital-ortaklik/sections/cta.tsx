...
/**
 * Dijital Ortaklık Call to Action Section
 */
export function CTA() {
  return (
      ...
      <div className="max-w-2xl mx-auto px-6">
        <ScrollReveal direction="up">
          <h2 className="font-cinzel text-section-heading font-semibold text-[var(--text-primary)] mb-4">
            Dijital Ortağımız Olun
          </h2>
          <p className="font-body text-body-lg text-[var(--text-secondary)] mb-8">
            Başvurunuzu yapın, 48 saat içinde ekibimiz sizinle iletişime geçsin.
          </p>
          <Link href="/iletisim/bayilik-basvurusu" className="btn-primary inline-block">Başvuru Yap</Link>
        </ScrollReveal>
      </div>
    </section>
  );
