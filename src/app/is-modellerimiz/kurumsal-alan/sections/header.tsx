      ...
      <div className="max-w-4xl mx-auto px-6">
        <ScrollReveal direction="up">
          ...
          <h1 className="font-cinzel text-hero font-bold text-[var(--text-primary)] mb-6">
            Kurumsal Alan <span className="text-[var(--accent-gold)]">Kokulandırma</span>
          </h1>
          <p className="font-body text-body-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
            Geniş alanlarda profesyonel koku difüzyon sistemleri ile marka kimliğinize uygun ambient kokulandırma.
          </p>
        </ScrollReveal>
      </div>
    </section>
