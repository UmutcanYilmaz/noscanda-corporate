      ...
      <div className="max-w-4xl mx-auto px-6">
        <ScrollReveal direction="up">
          ...
          <h1 className="font-cinzel text-hero font-bold text-[var(--text-primary)] mb-6">
            B2B <span className="text-[var(--accent-gold)]">Kurumsal</span>
          </h1>
          <p className="font-body text-body-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
            Otel, restoran, SPA and kurumsal ofisler için özel koku kimliği tasarımı and ambient kokulandırma çözümleri.
          </p>
        </ScrollReveal>
      </div>
    </section>
