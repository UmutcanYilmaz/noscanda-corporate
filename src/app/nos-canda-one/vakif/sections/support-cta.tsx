...
export function SupportCTA() {
  return (
    <section id="bize-destek-olun" className="py-10 md:py-14 bg-[var(--bg-secondary)] overflow-hidden relative border-t border-[var(--border-subtle)] pb-16 md:pb-24">
      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Title, Detailed text and button (Col span 6) */}
